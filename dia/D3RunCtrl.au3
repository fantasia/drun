...
Func ShowMainControlPannel()
   ...
   _ArrayAdd($buttons, "GotoMap2")
   _ArrayAdd($buttons, "GotoGhom")
   _ArrayAdd($buttons, "BattleWizard")
   _ArrayAdd($buttons, "BattleBudu")
   _ArrayAdd($buttons, "BattleDevilHunter")
   _ArrayAdd($buttons, "ToggleItems")
   _ArrayAdd($buttons, "ReturnBase")
   _ArrayAdd($buttons, "GotoDestroy")
